...
def parse_args(default=False):
    ...
    parser = ArgumentParser(
        description='PyTorch implementation of DUCAT'
    )
    ...
    ##### DUCAT Configurations #####
    parser.add_argument("--dummy", help='apply DUCAT',
                        action='store_true')
    parser.add_argument('--dummy_start', help='epoch to start DUCAT',
                        default=105, type=int)
    parser.add_argument('--dummy_end', help='epoch to end DUCAT',
                        default=130, type=int)
    parser.add_argument('--w_benign', help='hyper-parameter benign weight for DUCAT',
                        default=0.25, type=float)
    parser.add_argument('--w_adv', help='hyper-parameter adversarial weight for DUCAT',
                        default=1, type=float)
    parser.add_argument('--w_alpha', help='hyper-parameter preference for DUCAT',
                        default=1, type=float)
